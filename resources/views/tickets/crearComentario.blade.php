...
@section('content')
    <div class="contenedorCrearComentario">
        <form class="formCrearComentario" action="/guardar-opinio" method="post">
            @csrf
            ...
            <div class="contenedorPuntuacionIconos">
                <label for="sad2">
                  <input type="radio" name="rating" class="sad" id="sad2" value=1 />
                  <svg class="iconosComentarios" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="100%" height="100%" viewBox="0 0 24 24">
                ...
                <label for="happy2">
                  <input type="radio" name="rating" class="happy" id="happy2" value=2 checked />
                  <svg class="iconosComentarios" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="100%" height="100%" viewBox="0 0 24 24">
                ...
                <label for="super-happy2">
                  <input type="radio" name="rating" class="super-happy" id="super-happy2" value=3 />
                    ...
                    <fieldset>
                        <div class="stars-wrapper">
                            <div class="star-container">
                                <input id="1-star-rating" type="radio" name="reviewRating" value="1">
                            ...
                            <div class="star-container">
                                <input id="2-star-rating" type="radio" name="reviewRating" value="2">
                            ...
                            <div class="star-container">
                                <input id="3-star-rating" type="radio" name="reviewRating" value="3">
                            ...
                            <div class="star-container">
                                <input id="4-star-rating" type="radio" name="reviewRating" value="4">
                            ...
                            <div class="star-container">
                                <input id="5-star-rating" type="radio" name="reviewRating" value="5">
            ...
            <section>
                <div id="contenedorPuntuacion">
                    <div class="stars-wrapper">
                        <input class="starInput" id="one-star-rating-2" type="radio" name="reviewRating" value="1">
                        <label for="one-star-rating-2">1 Star</label>
                        <input class="starInput" id="two-star-rating-2" type="radio" name="reviewRating" value="2">
                        <label for="two-star-rating-2">2 Stars</label>
                        <input class="starInput" id="three-star-rating-2" type="radio" name="reviewRating" value="3">
                        <label for="three-star-rating-2">3 Stars</label>
                        <input class="starInput" id="four-star-rating-2" type="radio" name="reviewRating" value="4">
                        <label for="four-star-rating-2">4 Stars</label>
                        <input class="starInput" id="five-star-rating-2" type="radio" name="reviewRating" value="5">
            ...
            <button class="guardar-comentario" type="submit">Enviar</button>
        </form>
    </div>
@endsection
