...
|=======================
| Nom          | Hex       
| Fons i Contrast | pass:q[F0E6D2] 
| Principal    | pass:q[5C5346] 
| Botons i Trucades d'Ació | pass:q[D4AF37] 
| Text i Detalls | pass:q[1A1A1A] 
| Destacats i Enllaços | pass:q[C9B7A5] 
| Elements Secundaris | pass:q[857C6D] 
|=======================
