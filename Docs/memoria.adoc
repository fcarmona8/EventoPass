...
Ara descarguem l'imatge del Postgres -> docker pull postgres:latest
...
També podem obrir el docker fent -> sudo docker-compose up -d

En el fitxer docker-compose escribim:
